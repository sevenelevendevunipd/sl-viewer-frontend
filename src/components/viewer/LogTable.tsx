...
<DataTable value={(filteringService.filteredEntries)} removableSort sortField='timestamp' size='large' header={`Showing ${filteringService.filteredEntries.length} log entries`}
