...
import LogFilteringService, { ILogFilteringService, LogFilteringStrategy } from "../../../services/LogFilteringService";
...
it("LogTable", () => {
    ...
    render(<LogFilteringService logFilteringService={lfs}><LogTable/></LogFilteringService>);
    ...
    logs.log_entries.forEach(entry => {
        ...
        "description",
        "value"].forEach(field=>{
            const element = screen.getAllByText(new RegExp((entry as any)[field], "i"));
